...
class WriterApplicativeTest: XCTestCase {
    func testApplicativeLaws() {
        property("ap identity") <~ forAll() { (fa: Writer<Int, Int>) in
            
            Writer.pure(id).ap(fa)
                ==
            fa
        }
        ...
        property("homomorphism") <~ forAll() { (a: Int, f: ArrowOf<Int, Int>) in
            ...
            Writer.pure(f.getArrow).ap(Writer<Int, Int>.pure(a))
                ==
            Writer.pure(f.getArrow(a))
        }
        
        property("interchange") <~ forAll() { (a: Int, b: Int) in
            let fa = Writer<Int, (Int) -> Int>.pure(constant(a) as (Int) -> Int)
            
            return fa.ap(Writer.pure(b))
                ==
            Writer.pure({ (x: (Int) -> Int) in x(a) } ).ap(fa)
        }
        
        property("map derived") <~ forAll() { (fa: Writer<Int, Int>, f: ArrowOf<Int, Int>) in
            
            fa.map(f.getArrow)
                ==
            Writer.pure(f.getArrow).ap(fa)
        }
        ...
        property("Map with 6 inputs") <~ forAll { (a: Int, b: Int, c: Int, d: Int, e: Int, f: Int) in
            ...
            Writer<Int, Int>.map(
                ...
                ==
            Writer<Int, Int>.pure(a + b + c + d + e + f)
        }
        ...
        property("Map with 7 inputs") <~ forAll { (a: Int, b: Int, c: Int, d: Int, e: Int, f: Int, g: Int) in
            ...
            Writer<Int, Int>.map(
                ...
                ==
            Writer<Int, Int>.pure(a + b + c + d + e + f + g)
        }
        ...
        property("Map with 8 inputs") <~ forAll { (a: Int, b: Int, c: Int, d: Int, e: Int, f: Int, g: Int, h: Int) in
            ...
            Writer<Int, Int>.map(
                ...
                ==
            Writer<Int, Int>.pure(a + b + c + d + e + f + g + h)
        }
        ...
        property("Map with 9 inputs") <~ forAll { (a: Int, b: Int, c: Int, d: Int, e: Int, f: Int, g: Int, h: Int) in
            ...
            Writer<Int, Int>.map(
                ...
                ==
            Writer<Int, Int>.pure(a + b + c + d + e + f + g + h + a)
        }
    }
}
