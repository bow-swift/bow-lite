...
class OptionalApplicativeTest: XCTestCase {
    func testApplicativeLaws() {
        property("ap identity") <~ forAll() { (fa: Optional<Int>) in
            
            Optional.pure(id).ap(fa)
                ==
            fa
        }
        ...
        property("homomorphism") <~ forAll() { (a: Int, f: ArrowOf<Int, Int>) in
            ...
            Optional.pure(f.getArrow).ap(Optional<Int>.pure(a))
                ==
            Optional.pure(f.getArrow(a))
        }
        
        property("interchange") <~ forAll() { (a: Int, b: Int) in
            let fa = Optional<(Int) -> Int>.pure(constant(a) as (Int) -> Int)
            
            return fa.ap(Optional.pure(b))
                ==
            Optional.pure({ (x: (Int) -> Int) in x(a) } ).ap(fa)
        }
        
        property("map derived") <~ forAll() { (fa: Optional<Int>, f: ArrowOf<Int, Int>) in
            
            fa.map(f.getArrow)
                ==
            Optional.pure(f.getArrow).ap(fa)
        }
        ...
        property("Map with 7 inputs") <~ forAll { (a: Int, b: Int, c: Int, d: Int, e: Int, f: Int, g: Int) in
            ...
            Optional<Int>.map(
                ...
                ==
            Optional<Int>.pure(a + b + c + d + e + f + g)
        }
        ...
        property("Map with 8 inputs") <~ forAll { (a: Int, b: Int, c: Int, d: Int, e: Int, f: Int, g: Int, h: Int) in
            ...
            Optional<Int>.map(
                ...
                ==
            Optional<Int>.pure(a + b + c + d + e + f + g + h)
        }
        ...
        property("Map with 9 inputs") <~ forAll { (a: Int, b: Int, c: Int, d: Int, e: Int, f: Int, g: Int, h: Int) in
            ...
            Optional<Int>.map(
                ...
                ==
            Optional<Int>.pure(a + b + c + d + e + f + g + h + a)
        }
    }
}
