...
class EitherApplicativeTest: XCTestCase {
    func testApplicativeLaws() {
        property("ap identity") <~ forAll() { (fa: Either<Int, Int>) in
            
            Either.pure(id).ap(fa)
                ==
            fa
        }
        ...
        property("homomorphism") <~ forAll() { (a: Int, f: ArrowOf<Int, Int>) in
            ...
            Either.pure(f.getArrow).ap(Either<Int, Int>.pure(a))
                ==
            Either.pure(f.getArrow(a))
        }
        
        property("interchange") <~ forAll() { (a: Int, b: Int) in
            let fa = Either<Int, (Int) -> Int>.pure(constant(a) as (Int) -> Int)
            
            return fa.ap(Either.pure(b))
                ==
            Either.pure({ (x: (Int) -> Int) in x(a) } ).ap(fa)
        }
        
        property("map derived") <~ forAll() { (fa: Either<Int, Int>, f: ArrowOf<Int, Int>) in
            
            fa.map(f.getArrow)
                ==
            Either.pure(f.getArrow).ap(fa)
        }
        ...
        property("Map with 6 inputs") <~ forAll { (a: Int, b: Int, c: Int, d: Int, e: Int, f: Int) in
            ...
            Either<Int, Int>.map(
                ...
                ==
            Either<Int, Int>.pure(a + b + c + d + e + f)
        }
        ...
        property("Map with 7 inputs") <~ forAll { (a: Int, b: Int, c: Int, d: Int, e: Int, f: Int, g: Int) in
            ...
            Either<Int, Int>.map(
                ...
                ==
            Either<Int, Int>.pure(a + b + c + d + e + f + g)
        }
        ...
        property("Map with 8 inputs") <~ forAll { (a: Int, b: Int, c: Int, d: Int, e: Int, f: Int, g: Int, h: Int) in
            ...
            Either<Int, Int>.map(
                ...
                ==
            Either<Int, Int>.pure(a + b + c + d + e + f + g + h)
        }
        ...
        property("Map with 9 inputs") <~ forAll { (a: Int, b: Int, c: Int, d: Int, e: Int, f: Int, g: Int, h: Int) in
            ...
            Either<Int, Int>.map(
                ...
                ==
            Either<Int, Int>.pure(a + b + c + d + e + f + g + h + a)
        }
    }
}
